...
-   [Eunomia](https://ohdsi.github.io/Eunomia/) for connecting to a synthetic OMOP CDM database.
-   [PhenotypeLibrary](https://ohdsi.github.io/PhenotypeLibrary/) for pulling OHDSI-vetted cohort definitions.
-   [CohortGenerator](https://ohdsi.github.io/CohortGenerator/) for generating cohort tables in Eunomia
-   [CohortDiagnostics](https://ohdsi.github.io/CohortDiagnostics/) for launching RShiny app to view cohort diagnostics.
-   [DatabaseConnector](https://ohdsi.github.io/DatabaseConnector/) for connecting to our Eunomia dataset and executing queries
-   [SqlRender](install.packages("SqlRender") for translating sql templates from the phenotype library in "OHDSI SQL" to our target sql dialect (sqlite).

Other Packages used

-   [DT](https://rstudio.github.io/DT/) for viewing phenotype log in jquery datatables format.
-   [dplyr](https://dplyr.tidyverse.org/) for piping and data manipulation functions.
